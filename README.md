...
**Frontend**
`Nuxt 4` `Vue 3` `React` `Next.js` `TypeScript` `Tailwind CSS` `Framer Motion` `Pinia` `shadcn`

**Mobile**
`Capacitor` `iOS` `Android` `PWA` `Firebase`

**Backend & Database**
`Node.js` `Java` `Spring Boot` `Supabase` `PostgreSQL` `REST API`

**Tools & Services**
`Stripe` `Sentry` `Resend` `Upstash Redis` `Git` `Postman` `Vitest` `Zod`
...
- **Frontend Developer** @ TotalTCG (UK) · Feb 2026 – Present
- **Fullstack Developer (Freelance)** @ Sansar Sweden · Dec 2025 – Mar 2026
- **Fullstack Developer** @ Alexum AB · Jan 2025 – Aug 2025
- **Fullstack Developer** @ Speedyli (USA) · Sep 2022 – Mar 2023

---

## 📫 Contact

[![Portfolio](https://img.shields.io/badge/Portfolio-000000?style=flat&logo=vercel&logoColor=white)](https://omercelebi.se)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=flat&logo=linkedin&logoColor=white)](https://linkedin.com/in/omercelebii)
[![Email](https://img.shields.io/badge/Email-D14836?style=flat&logo=gmail&logoColor=white)](mailto:omer534@outlook.com)
